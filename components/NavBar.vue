      ...
      <div class="navigationBar">
        ...
        <div class="navButtons">
          <div class="optionButtonsContainer">
            <a class="optionButton ">Posiciones Ejecutivas</a>
            <a class="optionButton">Blog de Noticias</a>
